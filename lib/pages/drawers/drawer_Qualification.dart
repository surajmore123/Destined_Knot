...
class your_Qualification extends StatefulWidget {
  const your_Qualification({super.key});
              ...
              child: AnimatedBuilder(
                ...
                builder: (context, _) {
                  return Row(
                    children: [
                      Expanded(
                        flex: (_animation.value * 100)
                            .toInt(), // Convert to percentage and use as flex value
                        child: Container(
                          color: Color.fromARGB(255, 74, 154,
                              211), // Change this to your desired color
                        ),
                      ),
                      Expanded(
                        ...
                        InkWell(
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      color: selectedQuali.isNotEmpty
                                          ? Colors.pink
                                          : Colors.grey,
                                      width: 2)),
                              child: Align(
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 30,
                                      color:
                                          Color.fromARGB(255, 240, 135, 170)),
                                ),
                              ),
                              const SizedBox(
                                height: 20,
