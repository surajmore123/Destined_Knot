                ...
                builder: (context, child) {
                  return Transform.scale(
                    scale: _animation.value * 0.1 +
                        0.9, // Adjust the scaling as needed
                    child: child,
                  );
                },
                child: CircleAvatar(
                  radius: 56, //radius of avatar
                  backgroundColor: gallaryFile == null
                      ? Colors.green
                      : Colors.pink, // Default background color
                  child: ClipOval(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        'We have noticed that Members do not',
                                        style: TextStyle(color: Colors.grey),
                                      ),
                                    ),
                                    Text(
                                      'respond to Profiles without Photos',
                                      style: TextStyle(color: Colors.grey),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(
